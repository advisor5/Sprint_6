...
class LocatorsOrder:
    # Страница 1 заказа
    ORDER_HEADER_TITLE = (By.CLASS_NAME, "Order_Header__BZXOb") # Заголовок на странице зказа //div[text()='Для кого самокат']
    ...
    ORDER_BOTTON = (By.XPATH, "//div[@class='Order_Buttons__1xGrp']//button[text()='Заказать']") #  Кнопка Заказать
